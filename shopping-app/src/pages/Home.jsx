  ...
  return (
    <>
      <div className="flex-col justify-around gap-11">
        <div
          className="h-96 bg-cover bg-center flex flex-row justify-around"
          style={{ backgroundImage: `url('../src/images/heroshop.jpg')` }}
        >
          <h1 className="text-white font-extrabold text-5xl mt-10">
            {" "}
            All your wants and needs, in one place, indeed.
          </h1>
          <div className="bg-blue-800 text-white rounded-lg py-2 px-4 hover:bg-blue-700 hover:border-blue-500 hover:scale-105 focus:outline-none w-24 mr-10 self-end mb-40">
            <NavLink
              to="shop"
            >
              Explore.
